...
Security fixes are maintained on the current default branch while VOODOO-SKILLSET remains pre-release. Repository visibility or a passing CI run is not a production-readiness guarantee.
